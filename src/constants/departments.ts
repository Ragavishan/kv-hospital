...
export const departments: Department[] = [
...

  {
    ...
    content: {
      ...
      ta: {
        title: "எலும்பியல்",
        description:
          "எலும்புகள், மூட்டுகள், தசைகள் மற்றும் இயக்கம் தொடர்பான பிரச்சினைகளுக்கு முழுமையான சிகிச்சை.",
        fullDescription:
...

  {
    ...
    {
    id: 11,
    image: "/images/departments/diabetes.jpg",

    content: {
      en: {
        title: "Diabetology & Endocrinology",
        description:
          "Specialized care for diabetes, thyroid disorders, hormonal conditions, and metabolic health.",
        fullDescription:
          "Our Diabetology & Endocrinology department provides comprehensive care for diabetes, thyroid disorders, hormonal conditions, and other metabolic health concerns. Our specialists focus on accurate diagnosis, personalized treatment, lifestyle guidance, and long-term health management.",
        services: [
          ...
          "Obesity & Metabolic Health Management",
          "Endocrinology Consultation",
        ],
      },

      ta: {
        title: "நீரிழிவியல் & நாளமில்லா சுரப்பியல்",
        description:
          "நீரிழிவு, தைராய்டு, ஹார்மோன் மற்றும் வளர்சிதை மாற்றம் தொடர்பான பிரச்சினைகளுக்கான சிறப்பு சிகிச்சை.",
        fullDescription:
          "எங்கள் நீரிழிவியல் மற்றும் நாளமில்லா சுரப்பியல் துறை நீரிழிவு, தைராய்டு கோளாறுகள், ஹார்மோன் பிரச்சினைகள் மற்றும் வளர்சிதை மாற்றம் தொடர்பான உடல்நலப் பிரச்சினைகளுக்கு முழுமையான மருத்துவ பராமரிப்பை வழங்குகிறது. துல்லியமான நோயறிதல், தனிப்பட்ட சிகிச்சை, வாழ்க்கை முறை ஆலோசனை மற்றும் நீண்டகால உடல்நல மேலாண்மையில் எங்கள் நிபுணர்கள் கவனம் செலுத்துகின்றனர்.",
        services: [
          "நீரிழிவு பரிசோதனை & நோயறிதல்",
          "நீரிழிவு மேலாண்மை",
          "வகை 1 & வகை 2 நீரிழிவு சிகிச்சை",
          "தைராய்டு கோளாறு மேலாண்மை",
          "இரத்த சர்க்கரை கண்காணிப்பு",
          "இன்சுலின் சிகிச்சை மேலாண்மை",
          "நீரிழிவு சிக்கல்கள் பரிசோதனை",
          "வாழ்க்கை முறை & ஊட்டச்சத்து ஆலோசனை",
          "உடல் பருமன் & வளர்சிதை மாற்ற ஆரோக்கிய மேலாண்மை",
          "நாளமில்லா சுரப்பியல் ஆலோசனை",
        ],
      },

      ml: {
        title: "ഡയബറ്റോളജി & എൻഡോക്രൈനോളജി",
        description:
          "പ്രമേഹം, തൈറോയ്ഡ്, ഹോർമോൺ, മെറ്റബോളിക് ആരോഗ്യ പ്രശ്നങ്ങൾക്കുള്ള പ്രത്യേക പരിചരണം.",
        fullDescription:
          "ഞങ്ങളുടെ ഡയബറ്റോളജി & എൻഡോക്രൈനോളജി വിഭാഗം പ്രമേഹം, തൈറോയ്ഡ് രോഗങ്ങൾ, ഹോർമോൺ പ്രശ്നങ്ങൾ, മറ്റ് മെറ്റബോളിക് ആരോഗ്യ പ്രശ്നങ്ങൾ എന്നിവയ്ക്ക് സമഗ്രമായ പരിചരണം നൽകുന്നു. കൃത്യമായ രോഗനിർണയം, വ്യക്തിഗത ചികിത്സ, ജീവിതശൈലി മാർഗനിർദേശം, ദീർഘകാല ആരോഗ്യ നിയന്ത്രണം എന്നിവയിൽ ഞങ്ങളുടെ വിദഗ്ധർ ശ്രദ്ധ കേന്ദ്രീകരിക്കുന്നു.",
        services: [
          "പ്രമേഹ പരിശോധന & രോഗനിർണയം",
          "പ്രമേഹ നിയന്ത്രണം",
          "ടൈപ്പ് 1 & ടൈപ്പ് 2 പ്രമേഹ പരിചരണം",
          "തൈറോയ്ഡ് രോഗ നിയന്ത്രണം",
          "രക്തത്തിലെ പഞ്ചസാര നിരീക്ഷണം",
          "ഇൻസുലിൻ ചികിത്സാ നിയന്ത്രണം",
          "പ്രമേഹ സങ്കീർണ്ണത പരിശോധന",
          "ജീവിതശൈലി & പോഷകാഹാര മാർഗനിർദേശം",
          "അമിതവണ്ണം & മെറ്റബോളിക് ആരോഗ്യ നിയന്ത്രണം",
          "എൻഡോക്രൈനോളജി കൺസൾട്ടേഷൻ",
        ],
      },

      te: {
        title: "డయాబెటాలజీ & ఎండోక్రైనాలజీ",
        description:
          "మధుమేహం, థైరాయిడ్, హార్మోన్ మరియు మెటబాలిక్ ఆరోగ్య సమస్యలకు ప్రత్యేక వైద్య సంరక్షణ.",
        fullDescription:
          "మా డయాబెటాలజీ & ఎండోక్రైనాలజీ విభాగం మధుమేహం, థైరాయిడ్ సమస్యలు, హార్మోన్ సంబంధిత సమస్యలు మరియు ఇతర మెటబాలిక్ ఆరోగ్య సమస్యలకు సమగ్ర వైద్య సంరక్షణను అందిస్తుంది. ఖచ్చితమైన నిర్ధారణ, వ్యక్తిగత చికిత్స, జీవనశైలి మార్గదర్శకం మరియు దీర్ఘకాలిక ఆరోగ్య నిర్వహణపై మా నిపుణులు దృష్టి పెడతారు.",
        services: [
          "మధుమేహ పరీక్ష & నిర్ధారణ",
          "మధుమేహ నిర్వహణ",
          "టైప్ 1 & టైప్ 2 మధుమేహ సంరక్షణ",
          "థైరాయిడ్ సమస్యల నిర్వహణ",
          "రక్తంలో చక్కెర పర్యవేక్షణ",
          "ఇన్సులిన్ చికిత్స నిర్వహణ",
          "మధుమేహ సమస్యల స్క్రీనింగ్",
          "జీవనశైలి & పోషకాహార మార్గదర్శకం",
          "ఊబకాయం & మెటబాలిక్ ఆరోగ్య నిర్వహణ",
          "ఎండోక్రైనాలజీ సంప్రదింపు",
        ],
      },

      hi: {
        title: "डायबेटोलॉजी और एंडोक्राइनोलॉजी",
        description:
          "मधुमेह, थायरॉइड, हार्मोन और मेटाबॉलिक स्वास्थ्य संबंधी समस्याओं के लिए विशेष चिकित्सा देखभाल।",
        fullDescription:
          "हमारा डायबेटोलॉजी और एंडोक्राइनोलॉजी विभाग मधुमेह, थायरॉइड विकार, हार्मोन संबंधी समस्याओं और अन्य मेटाबॉलिक स्वास्थ्य स्थितियों के लिए व्यापक चिकित्सा देखभाल प्रदान करता है। हमारे विशेषज्ञ सटीक निदान, व्यक्तिगत उपचार, जीवनशैली मार्गदर्शन और दीर्घकालिक स्वास्थ्य प्रबंधन पर ध्यान केंद्रित करते हैं।",
        services: [
          "मधुमेह जांच और निदान",
          "मधुमेह प्रबंधन",
          "टाइप 1 और टाइप 2 मधुमेह देखभाल",
          "थायरॉइड विकार प्रबंधन",
          "ब्लड शुगर की निगरानी",
          "इंसुलिन थेरेपी प्रबंधन",
          "मधुमेह संबंधी जटिलताओं की जांच",
          "जीवनशैली और पोषण संबंधी मार्गदर्शन",
          "मोटापा और मेटाबॉलिक स्वास्थ्य प्रबंधन",
          "एंडोक्राइनोलॉजी परामर्श",
        ],
      },
    },
  },

  {
    ...
    content: {
      ...
      ta: {
        title: "அவசர சிகிச்சை",
        description:
          "24 × 7 மணி நேரமும் அவசர மருத்துவ சேவைகள் வழங்கப்படுகின்றன. அவசர நிலைகளில் விரைவான மற்றும் நம்பகமான சிகிச்சை வழங்கப்படுகிறது.",
        fullDescription:
