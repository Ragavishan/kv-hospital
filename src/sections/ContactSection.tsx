...
ta: {
  ...
  mapAddress:
    "திண்டுக்கல் – பழனி நெடுஞ்சாலை, லட்சுமிபுரம், பழனி - 624601, தமிழ்நாடு, இந்தியா.",
...
ml: {
  ...
  mapAddress:
    "ദിണ്ടിഗൽ – പഴനി പ്രധാന റോഡ്, ലക്ഷ്മിപുരം, പഴനി - 624601, തമിഴ്നാട്, ഇന്ത്യ.",
...
te: {
  ...
  mapAddress:
    "దిండిగల్ – పలని ప్రధాన రహదారి, లక్ష్మీపురం, పలని - 624601, తమిళనాడు, ఇండియ.",
...
hi: {
  ...
  mapAddress:
    "डिंडीगुल – पलानी मुख्य मार्ग, लक्ष्मीपुरम, पलानी - 624601, तमिलनाडु, भारत.",
